      ...
      //$newvalue = array();
               	...
               	if($result != NULL){
               	    ...
               	    while($row = $result->fetch_assoc()) {
						...
						<tr><th>Gender Taken: </th><td><input type='text' id='number' name='number' value=".$row["Gendertaken"]." size='2' readonly></td><td><button type='button' class='updatebutton' onclick='add();'>&nbsp + &nbsp</button> <button class='updatebutton' type='button' onclick='minus();'>&nbsp - &nbsp</button></td><td><input type='submit' value='Update' name='submit' class='updatebutton' id='submit'></td></tr>
