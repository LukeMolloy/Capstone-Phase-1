...
<body>
    <div class="loginform">
        ...
        WHERE Email = AES_ENCRYPT('$a', 'show2016')";
               	...
               	echo "<table align='center' cellspacing='50'><tr><th colspan='2'>Safe Haven Owner</th> <th>PhoneNumber</th> <th>Email</th> <th>Address</th> <th>Suburb</th> <th>City</th> <th>State</th><th></th></tr>";
               	if($result != NULL){
