...
<div class="header">
	...
	<div class="loginform">
		<div class="instructions">
			...
			<p>These details will help narrow down the list of safe houses to those applicable to the client.</p><p>These details will also be sent to the safehouse that the client ends up being placed in.</p></td>
			<td>
