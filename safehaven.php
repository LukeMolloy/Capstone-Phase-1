        ...
        <br /> <br />
            <?php
        		...
        		$userDependants = $_SESSION['ClientDependants'];
               	...
               	$sql = "SELECT (AES_DECRYPT(FirstName, 'show2016')), LastName, PhoneNumber, Email, Address, Suburb, Postcode, City, State, Spacesavailable, Petfriendly, Gendertaken, Authorised, Nights FROM House WHERE LastName = 'Name'";
