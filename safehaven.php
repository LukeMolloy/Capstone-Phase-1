        ...
        <br /> <br />
            <?php
        		...
        		$userDependants = $_SESSION['ClientDependants'];
               	...
               	$sql = "SELECT (CAST(AES_DECRYPT(FirstName, 'show2016')) AS CHAR(50)), LastName, PhoneNumber, Email, Address, Suburb, Postcode, City, State, Spacesavailable, Petfriendly, Gendertaken, Authorised, Nights FROM House WHERE LastName = 'Name'";
